...
const file_proto_scheduler_proto_rawDesc = "" +
	...
	"\rMonitorWorker\x12\x1e.scheduler.WorkerStatusRequest\x1a\x1f.scheduler.WorkerStatusResponse0\x01B%Z#github.com/training-scheduler/protob\x06proto3"
...
var file_proto_scheduler_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_proto_scheduler_proto_goTypes = []any{
	...
	(*TaskSummary)(nil),            // 13: scheduler.TaskSummary
}
var file_proto_scheduler_proto_depIdxs = []int32{
	...
	13, // 9: scheduler.WorkerStatusResponse.active_tasks:type_name -> scheduler.TaskSummary
	1,  // 10: scheduler.TaskSummary.status:type_name -> scheduler.TaskStatus
	5,  // 11: scheduler.TrainingScheduler.RegisterWorker:input_type -> scheduler.RegisterWorkerRequest
	7,  // 12: scheduler.TrainingScheduler.RequestTask:input_type -> scheduler.TaskRequest
	8,  // 13: scheduler.TrainingScheduler.ReportTaskStatus:input_type -> scheduler.TaskStatusUpdate
	11, // 14: scheduler.TrainingScheduler.MonitorWorker:input_type -> scheduler.WorkerStatusRequest
	6,  // 15: scheduler.TrainingScheduler.RegisterWorker:output_type -> scheduler.RegisterWorkerResponse
	4,  // 16: scheduler.TrainingScheduler.RequestTask:output_type -> scheduler.Task
	10, // 17: scheduler.TrainingScheduler.ReportTaskStatus:output_type -> scheduler.TaskStatusResponse
	12, // 18: scheduler.TrainingScheduler.MonitorWorker:output_type -> scheduler.WorkerStatusResponse
